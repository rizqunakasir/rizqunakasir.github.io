    ...
    <div className={`min-h-screen flex flex-col bg-panel-bg text-slate-800 font-sans selection:bg-accent/25 selection:text-slate-900 ${isDarkMode ? 'dark' : ''}`}>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-6 overflow-hidden">
        ...
        <section className="lg:col-span-4 bg-white rounded-2xl border border-slate-250 shadow-sm p-4 md:p-5 flex flex-col gap-4 overflow-y-auto min-h-[500px] max-h-[850px]">
          ...
          <div className="bg-slate-50 dark:bg-amber-950/15 border border-slate-200 dark:border-amber-900/50 p-4 rounded-xl flex flex-col items-center justify-center text-center shadow-xs">
            <span className="text-[10px] font-bold text-slate-500 dark:text-amber-400 uppercase tracking-widest select-none">
              Total Tagihan Pembayaran
            </span>
            <span className="text-2xl font-black font-display text-slate-900 dark:text-amber-350 mt-1">
          ...
          <div className="animate-fadeIn pb-12 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
              <div className="p-4 bg-slate-50/50 border-b flex justify-between items-center">
                <span className="font-bold text-black dark:text-slate-200 text-xs">Total Data Katalog: {products.length} Items</span>
                  ...
                  <tbody>
                    {products.length === 0 ? (
                      ...
                      products.map((p, index) => (
                        <tr key={index} className="group hover:bg-slate-50/85 dark:hover:bg-slate-800/40 border-b border-slate-100 text-slate-700 dark:text-slate-200 transition-colors">
                          ...
                          <td className="p-3 font-semibold text-slate-900 dark:text-white transition-colors group-hover:text-black dark:group-hover:text-white">
                            <div>{p.nama}</div>
                            {p.id && (
                              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-mono font-medium mt-0.5 select-all transition-colors group-hover:text-slate-800 dark:group-hover:text-slate-200">
                                ID: {p.id}
                              </p>
                            )}
                          </td>
              ...
              <>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                  ...
                  <div className="p-4 md:p-5 border-b border-slate-100 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <h3 className="font-display font-bold text-black dark:text-white tracking-tight text-sm flex items-center gap-2">
                      ...
                      <tbody>
                        {filteredSheetRows.length === 0 ? (
                          ...
                          filteredSheetRows.map((row, index) => {
                            ...
                            return (
                              <tr key={index} className="group hover:bg-slate-55 dark:hover:bg-slate-800/40 border-b border-slate-100 text-slate-705 dark:text-slate-200 transition-colors">
                                <td className="p-3 font-mono font-bold text-primary dark:text-slate-200 transition-colors group-hover:text-black dark:group-hover:text-white">{transactionNo || `-`}</td>
                                <td className="p-3 font-mono text-slate-600 dark:text-slate-350 transition-colors group-hover:text-slate-900 dark:group-hover:text-white">{tgl}</td>
                                <td className="p-3 font-bold text-slate-800 dark:text-slate-200 transition-colors group-hover:text-black dark:group-hover:text-white">{customerName || `-`}</td>
                                <td className="p-3">
                                ...
                                <td className="p-3 max-w-[200px] truncate transition-colors group-hover:text-slate-950 dark:group-hover:text-slate-100" title={formattedItems}>
                                  {formattedItems || `-`}
                                </td>
                                <td className="p-3 text-right font-black text-slate-900 dark:text-slate-200 font-mono transition-colors group-hover:text-black dark:group-hover:text-white">
            ...
            <div className="bg-white rounded-3xl max-w-2xl w-full p-6 border border-slate-200 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
                  ...
                  <tbody>
                    {itemsList.length === 0 ? (
                      ...
                      itemsList.map((item, idx) => (
                        <tr key={idx} className="group border-b border-slate-100 text-slate-700 dark:text-slate-200 hover:bg-slate-55 dark:hover:bg-slate-800/30 transition-colors">
                          <td className="p-3 font-semibold text-slate-900 dark:text-slate-200 transition-colors group-hover:text-black dark:group-hover:text-white">
                            {item.nama}
                            {item.catatan || item.note ? (
                              <div className="text-[10px] text-slate-550 dark:text-slate-400 font-normal italic mt-0.5 transition-colors group-hover:text-slate-805 dark:group-hover:text-slate-200">Catatan: {item.catatan || item.note}</div>
                            ) : null}
                          </td>
                          <td className="p-3 font-mono text-[11px] text-slate-500 dark:text-slate-400 transition-colors group-hover:text-slate-800 dark:group-hover:text-slate-200">{item.ukuran || item.varian || '-'}</td>
                          <td className="p-3 text-center font-bold transition-colors group-hover:text-black dark:group-hover:text-white">{item.qty}</td>
                          <td className="p-3 text-right font-mono transition-colors group-hover:text-slate-900 dark:group-hover:text-white">Rp {Number(item.harga || 0).toLocaleString('id-ID')}</td>
                          <td className="p-3 text-right font-mono font-bold text-slate-900 dark:text-slate-200 transition-colors group-hover:text-black dark:group-hover:text-white">Rp {Number((item.qty || 1) * (item.harga || 0)).toLocaleString('id-ID')}</td>
                        </tr>
                      ))
                    )}
                  </tbody>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-150">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500 text-white font-bold text-xs rounded-full transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 shadow-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 text-white font-bold text-xs rounded-full transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 shadow-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-bold text-xs rounded-full transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 shadow-sm"
                >
                  <Download className="w-4 h-4" />
                  Unduh JPG
                </button>
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-rose-600 hover:bg-rose-700 dark:bg-rose-600 dark:hover:bg-rose-500 text-white font-bold text-xs rounded-full transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 shadow-sm"
                >
